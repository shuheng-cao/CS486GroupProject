...
\begin{itemize}
 ...
 \begin{figure}[h!]
    ...
    \caption{Detailed design and implementation for the Tetris environment as well as the three agents used in the report: handcrafted agent, local search agent, and reinforcement learning agent.}
    \label{fig:uml}
  \end{figure}
