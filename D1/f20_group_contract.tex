...
\begin{itemize}
  ...
  \item Report writing.
\end{itemize}
Actually, we are not going to divide ourselves into specific roles. We are planning to be task-based. Each one of us will be assigned certain tasks after the meeting, and we will complete the task , but also work together. So that everyone will have some understanding 
